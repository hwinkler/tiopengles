...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.tiopengles.js')
	...
	f = os.path.join(cwd,'Classes','ComTiopenglesModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.tiopengles.js']
